...
var LazyLoadedSessionRecording = /** @class */ (function () {
    ...
    LazyLoadedSessionRecording.prototype._warnIfClientMaskingShadowsServer = function () {
        ...
        var divergentFields = ['maskAllInputs', 'maskTextSelector', 'blockSelector'].filter(function (field) {
    ...
    LazyLoadedSessionRecording.prototype._onTriggerActivated = function () {
    ...
    LazyLoadedSessionRecording.prototype.start = function (startReason) {
        ...
        (0, general_utils_1.addEventListener)(globals_1.window, 'visibilitychange', this._onVisibilityChange);
