...
import { RageclickConfig, SessionIdChangedCallback, DeadClicksAutoCaptureConfig, SupportedWebVitalsMetrics, Properties, CaptureResult, SurveyRenderReason, ToolbarParams, FeatureFlagsCallback, JsonType, FeatureFlagDetail, FeatureFlagResult, FeatureFlagOptions, RemoteConfigFeatureFlagCallback, IsFeatureEnabledOptions, OverrideFeatureFlagsOptions, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, CaptureLogOptions, Logger, CaptureMetricOptions, PostHog as PostHog$1, PostHogConfig as PostHogConfig$1, EventName, RequestResponse, SeverityLevel, RequestQueueConfig, TreeShakeable, RequestCallback, CaptureOptions, Property, ExceptionAutoCaptureConfig } from '@posthog/types';
...
import { Survey, DisplaySurveyType, SurveyPosition, PropertyMatchType, SurveyEventWithFilters, SurveyActionType, RemoteConfig, Compression, SessionRecordingRemoteConfig } from '@posthog/browser-common';
